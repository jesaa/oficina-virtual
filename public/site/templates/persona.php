...
foreach($array2['usuarios'][$page->id_per]['registro'] as $usuFe){
...
foreach($u->children() as $userTime){
    ...
    foreach($pages->find("template=permiso, id_per=$u->id, aprobado=1") as $userTime){
...
include('./_head.php'); ?>
  ...
  <body class="nav-md">
        ...
        <div class="right_col" role="main">
          ...
          <div class="row tile_count">
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              ...
              <div class="count"><?= $u->children()->count()+$pages->find("template=permiso, id_per=$u->id, aprobado=1")->count() ?></div>
            ...
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
              ...
              <div class="count"><?= round($totalF) ?></div>
              <!-- <span class="count_bottom"><i class="green"><i class="fa fa-sort-asc"></i>34% </i> Esta semana</span> -->
            </div>
            <div class="col-md-2 col-sm-4 col-xs-6 tile_stats_count">
    ...
    <?php $labels=""; $iniciales=""; $finales=""; $eventI=""; $eventF="";
            ...
            $horaI=$array2['usuarios'][$page->id_per]['registro'][$label][0]['hora'];
            $partes = explode(':', $horaI);
            $segundos = ($partes[0] * 3600 + $partes[1] * 60 + $partes[2]);
            $horaF=($array2['usuarios'][$page->id_per]['registro'][$label][0]['hora']==end($array2['usuarios'][$page->id_per]['registro'][$label])['hora']) ? '00:00':end($array2['usuarios'][$page->id_per]['registro'][$label])['hora'];
            ...
            foreach($arrayAus as $num => $val){
                $fecha=$val;
                $u=$users->get("email=$page->email");
                $all=$pages->find("template=permiso, id_per=$u->id, aprobado=1");
                $arrayAll=array();
                    foreach($all as $key => $a){
                  ...
                  <ul class="nav navbar-right panel_toolbox">
                    <li class="dropdown">
                      ...
                      <ul class="dropdown-menu" role="menu">
                        <li><a href="/personal/<?=$page->title?>/06-2018">Junio 2018</a></li>
                        <li><a href="/personal/<?=$page->title?>/07-2018">Julio 2018</a></li>
                        <li><a href="/personal/<?=$page->title?>/08-2018">Agosto 2018</a></li>
                        <li><a href="/personal/<?=$page->title?>/09-2018">Septiembre 2018</a></li>
                        <li><a href="/personal/<?=$page->title?>/10-2018">Octubre 2018</a></li>
                        <li><a href="/personal/<?=$page->title?>/11-2018">Noviembre 2018</a></li>
                        <li><a href="/personal/<?=$page->title?>/12-2018">Diciembre 2018</a></li>
                      </ul>
                    </li>
                  ...
                  <table id="datatable-buttons" class="table table-striped table-bordered">
                   ...
                   <?php foreach($arrayDa as $key => $value){ ?> 
                      <tr>
                        ...
                        <?php $horaI=$array2['usuarios'][$page->id_per]['registro'][$value][0]['hora'];
                              $horaF=($array2['usuarios'][$page->id_per]['registro'][$value][0]['hora']==end($array2['usuarios'][$page->id_per]['registro'][$value])['hora']) ? '':end($array2['usuarios'][$page->id_per]['registro'][$value])['hora'];
                              $color="";
                        ...
                        <?php $newValue=$arrayAus[$key];   $ausen=$u->children();  ?>
                        <td><?php foreach($ausen as $even){
                            ...
                            foreach($pages->find("template=permiso, id_per=$u->id, aprobado=1") as $perm){ 
