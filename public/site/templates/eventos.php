...
<style type="text/css">
  ...
  <body class="nav-md">
              ...
              <div class="x_panel">
                ...
                <div class="x_content">
                  ...
                  <table id="datatable-buttons1" class="table table-striped table-bordered">
                    ...
                    <tbody>
                    <?php 
                    foreach($pages->find("template=evento") as $eventoUsuario){ ?> 
                      <tr id="tr-<?=$eventoUsuario->id;?>">
                         <td><?= ucwords(mb_strtolower($eventoUsuario->createdUser->nombre)) ?></td>
	...
	$("#datatable-buttons1").DataTable({
            ...
            language: { url: "https://cdn.datatables.net/plug-ins/1.10.19/i18n/Spanish.json", buttons: {
