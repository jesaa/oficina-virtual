<?php $filename = "../data/user.dat";
$handle = fopen($filename, "r");
$contents = fread($handle, filesize($filename));
fclose($handle);

$claves = preg_split('/\d+\K/', $contents);

$array['users']=array();

foreach($claves as $clave){
    
    $user=preg_split('/(?<=\D)(?=\d)|\d+\K/', $clave);
    $array['users'][]=array('id' => $user[1], 'name' => $user[0]);
          ...
          <div class="">
            ...
            <div class="row">
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2>Personal<small>Ultima actualización 14/Agosto/2018</small></h2>
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable-buttons" class="table table-striped table-bordered">
                      ...
                      <tbody>
                         <?php foreach(array_filter($array['users']) as $user){
                          if(empty(trim($user['name']))) continue;?> 
                        <tr>
                          <td><?= preg_replace('([^A-Za-z0-9])', '', $user['name']); ?></td>
                          <td></td>
                          <td></td>
                          <td><a href=""></a></td>
                          <td><button type="button" class="btn btn-success btn-xs">Consultar</button></td>
                        </tr>
                    <?php } ?>
                      </tbody>
                    </table>
